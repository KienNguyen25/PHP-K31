...
<html lang="en">
    ...
    <link href="User/css/version/marketing.css" rel="stylesheet">
...
<body>
        ...
        <header class="market-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand" href="marketing-index.php"><img src="images/version/market-logo.png" alt=""></a>
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="marketing-index.php">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="marketing-category.php">Marketing</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="marketing-category.php">Make Money</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="marketing-blog.php">Blog</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="marketing-contact.php">Contact Us</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-title-area">
                                ...
                                <span class="color-yellow"><a href="marketing-category.php" title="">Lifestyle</a></span>

                                <h3>The golden rules you need to know for a positive life</h3>

                                <div class="blog-meta big-meta">
                                    <small><a href="marketing-single.php" title="">21 July, 2017</a></small>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="blog-box">
                                            <div class="post-media">
                                                <a href="marketing-single.php" title="">
                                            ...
                                            <div class="blog-meta">
                                                <h4><a href="marketing-single.php" title="">We are guests of ABC Design Studio</a></h4>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="blog-box">
                                            ...
                                            <div class="blog-meta">
                                                <h4><a href="marketing-single.php" title="">Nostalgia at work with family</a></h4>
                            ...
                            <div class="widget">
                                ...
                                <div class="blog-list-widget">
                                    <div class="list-group">
                                        <a href="marketing-single.php" class="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <br>
                        <br>
                        <div class="copyright">&copy; Markedia. Design: <a href="http://php.design">php Design</a>.</div>
                    </div>
                </div>
            </div><!-- end container -->
        </footer><!-- end footer -->
    ...
    <script src="User/js/animate.js"></script>
