...
<html lang="en">
    ...
    <input type="hidden" id="" placeholder="" name="id" value="<?= $post['id'] ?? ''?>">
    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" cols="50" rows="10" ><?= $post['description'] ?? '' ?></textarea>
            </div>
            <div class="form-group">
                <label for="">Thumbnail</label>
                <input type="text" class="form-control" id="" placeholder="Nhập Link ảnh thumb" name="thumbnail" value="<?= $post['thumbnail'] ?? ''?>">
                <img src="<?= $post['thumbnail'] ?? ''?>" style="max-width: 300px" alt="">
            </div><br>
